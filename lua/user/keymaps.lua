...
keymap("n", "<leader>p", "<cmd>lua require'telescope.builtin'.buffers(require('telescope.themes').get_dropdown({ previewer = false, sort_lastused = true, ignore_current_buffer = true }))<cr>", opts)
